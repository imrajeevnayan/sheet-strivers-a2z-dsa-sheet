...
This solution was accepted on LeetCode using Problem List. The detected topics are String, String Matching. Review the synced source file for the implementation details.
