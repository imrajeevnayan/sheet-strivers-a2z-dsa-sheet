...
This solution was accepted on LeetCode using Prefix Sum. The detected topics are Array, Dynamic Programming, Prefix Sum. Review the synced source file for the implementation details.
