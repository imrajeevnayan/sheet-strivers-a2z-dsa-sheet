...
This solution was accepted on LeetCode using Problem List. The detected topics are Math, Dynamic Programming, Breadth-First Search. Review the synced source file for the implementation details.
